...
<header><div className="wrap nav"><a className="brand" href="/">WORKING TRADE CO.</a><nav className="navlinks"><a href="/junk-removal">Junk Removal</a><a href="/whats-included">What's Included</a><a href="/faq">FAQ</a><a className="btn" href="/junk-removal">GET THE KIT — $29</a></nav></div></header>
{children}
